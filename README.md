...
It possible to query the outputs using :
...
5. Verify the deployment was succesful
...
Go to the Cloud9 console and open the IDE created for you and **open a Terminal**
